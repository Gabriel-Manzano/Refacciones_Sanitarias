...
<body>
  <div class="relative flex min-h-screen items-center justify-center bg-[#f0f2f5]">
    <div class="flex flex-col w-full max-w-lg bg-white rounded-xl p-6 shadow-lg">
      ...
      <form class="flex flex-col gap-4" action="{{ route('registro.store') }}" method="POST">
        @csrf
        ...
        <label class="flex flex-col gap-2">
          ...
          <input name="correo" type="email" placeholder="ejemplo@correo.com"
            class="form-input px-4 py-2 rounded-xl bg-[#f0f2f5] border-none text-[#111518] placeholder:text-[#60778a] focus:ring-2 focus:ring-[#111518]"
            required />
        </label>
        <!-- Campo de Contraseña -->
        <label class="flex flex-col gap-2">
          ...
          <input name="contraseña" type="password" placeholder="Crea una contraseña"
            class="form-input px-4 py-2 rounded-xl bg-[#f0f2f5] border-none text-[#111518] placeholder:text-[#60778a] focus:ring-2 focus:ring-[#111518]"
            required />
        </label>
        ...
        <label class="flex flex-col gap-2">
          ...
          <input name="contraseña_confirmation" type="password" placeholder="Confirma tu contraseña"
            class="form-input px-4 py-2 rounded-xl bg-[#f0f2f5] border-none text-[#111518] placeholder:text-[#60778a] focus:ring-2 focus:ring-[#111518]"
            required />
        </label>
        <!-- Botón de Registro -->
