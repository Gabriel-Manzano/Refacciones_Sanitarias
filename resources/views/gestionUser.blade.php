            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-2">
                <div class="flex items-center gap-3 px-3 py-2">
                  <p class="text-[#111518] text-sm font-medium leading-normal">Tablero</p>
                </div>
                <div class="flex items-center gap-3 px-3 py-2">
                ...
                <div class="flex items-center gap-3 px-3 py-2 rounded-xl bg-[#f0f2f5]">
                  <p class="text-[#111518] text-sm font-medium leading-normal">Usuarios</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="px-4 py-3">
            <label class="flex flex-col min-w-40 h-12 w-full">
              <div class="flex w-full flex-1 items-stretch rounded-xl h-full">
                ...
                <input placeholder="Buscar usuarios por correo electrónico"
