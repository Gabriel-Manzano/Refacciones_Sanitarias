                ...
                <div class="card-body">
                    <form action="{{ route('usuarios.store') }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text"
                                class="form-control w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                                id="nombre" name="nombre" value="{{ old('nombre') }}" required>
                            <!-- Mostrar error si existe en una línea -->
                            {{ $errors->first('nombre') }}
                        </div>
